...
keyAliases: {
 ...
 // toleranter typo-fänger
  ...
  a2p3: "cartridge_type",
  antibeschlag: "anti_fog",
  arbeitsbock: "work_platform_type",
  arbeitsplattform: "work_platform_type",
  "arc-schutz": "arc_protection_class",
  atemschutztyp: "respirator_type",
  auffanggurt: "fall_protection_type",
  automatikfilter: "auto_darkening_filter",
  bandlaenge: "lanyard_length_m",
  bandlänge: "lanyard_length_m",
  belastbarkeit: "load_capacity_kg",
  belueftung: "helmet_ventilation",
  belüftung: "helmet_ventilation",
  beschichtung: "glove_coating",
  boa: "closure_system",
  "boa-verschluss": "closure_system",
  chemikalienschutz: "chemical_resistance",
  compositekappe: "toe_cap_material",
  cordura: "reinforcement_material",
  daemmung: "attenuation_db",
  din: "norm",
  "din 13157": "first_aid_standard",
  "din 13169": "first_aid_standard",
  drehverschluss: "helmet_adjustment",
  durchtrittschutz: "penetration_protection",
  durchtrittsicher: "penetration_protection",
  dämmung: "attenuation_db",
  einweg: "disposable_material",
  en: "norm",
  "en 388": "cut_standard",
  "en iso 20345": "safety_standard",
  "en-iso-20345": "safety_standard",
  esd: "esd",
  filterklasse: "filter_class",
  flammenhemmend: "flame_protection",
  flammschutz: "flame_protection",
  gefuettert: "winter_insulation",
  gefüttert: "winter_insulation",
  gehoerschutztyp: "hearing_protection_type",
  gehörschutztyp: "hearing_protection_type",
  gerüstbock: "work_platform_type",
  gummiband: "strap",
  helmtyp: "helmet_type",
  hitzeschutz: "heat_resistance_c",
  hoehenarbeit: "fall_protection_type",
  höhenarbeit: "fall_protection_type",
  "iso 7010": "sign_standard",
  kg: "fire_extinguisher_weight_kg",
  "klasse 1": "hi_vis_class",
  "klasse 2": "hi_vis_class",
  "klasse 3": "hi_vis_class",
  "knee pockets": "knee_pockets",
  kniepolster: "knee_pad_included",
  knietaschen: "knee_pockets",
  kunststoffkappe: "toe_cap_material",
  latex: "disposable_material",
  "latex-beschichtung": "glove_coating",
  laufsohle: "outsole_material",
  leiterart: "ladder_type",
  leiterlaenge: "ladder_length_m",
  leiterlänge: "ladder_length_m",
  leitermaterial: "ladder_material",
  lichtbogenschutz: "arc_protection_class",
  loeschdecke: "fire_blanket_size",
  loeschleistung: "fire_extinguisher_rating",
  loeschmittel: "fire_extinguisher_agent",
  löschdecke: "fire_blanket_size",
  löschleistung: "fire_extinguisher_rating",
  löschmittel: "fire_extinguisher_agent",
  "max belastung": "max_load_kg",
  "max. belastung": "max_load_kg",
  metallfrei: "metal_free",
  nitril: "disposable_material",
  nitrilbeschichtung: "glove_coating",
  norm: "norm",
  pannenschutz: "penetration_protection",
  "pu-beschichtung": "glove_coating",
  ratsche: "helmet_adjustment",
  reflektoren: "reflective_elements",
  reflexstreifen: "reflective_elements",
  rutschfestigkeit: "slip_resistance",
  rutschhemmung: "slip_resistance",
  "s-klasse": "safety_class",
  schafthoehe: "boot_height",
  schafthöhe: "boot_height",
  schildgroesse: "sign_size",
  schildgröße: "sign_size",
  schildmaterial: "sign_material",
  schnittschutz: "cut_protection_class",
  schnittschutzklasse: "cut_protection_class",
  schnittschutzlevel: "cut_level",
  schnittschutzstufe: "cut_level",
  schutzbrillentyp: "eyewear_type",
  schutzhelmtyp: "helmet_type",
  schutzklasse: "safety_class",
  schweisser: "welding_protection",
  schweisserschutz: "welding_protection",
  schweißer: "welding_protection",
  schweißerschutz: "welding_protection",
  sehstärke: "diopter",
  seillaenge: "rope_length_m",
  seillänge: "rope_length_m",
  seitenschutz: "side_protection",
  sicherheitsgurt: "fall_protection_type",
  sicherheitskennzeichen: "sign_standard",
  sicherheitsklasse: "safety_class",
  sicherheitsstufe: "safety_class",
  sohlenmaterial: "outsole_material",
  src: "slip_resistance",
  stahlkappe: "toe_cap_material",
  stufen: "steps",
  taschenanzahl: "pocket_count",
  temperaturbestaendig: "heat_resistance_c",
  temperaturbeständig: "heat_resistance_c",
  tragkraft: "max_load_kg",
  ventil: "valve",
  "verbandkasten-norm": "first_aid_standard",
  verdunkelung: "auto_darkening_filter",
  vinyl: "disposable_material",
  visier: "visor_included",
  visiermaterial: "visor_material",
  warnschutzklasse: "hi_vis_class",
  wechselfilter: "cartridge_type",
  "wechsel­filter": "cartridge_type",
  werkzeugtaschen: "tool_pockets",
  winterfutter: "winter_insulation",
  zehenschutzkappe: "toe_cap_material",
  zwischensohle: "penetration_material",
},
 ...
 "air_flow",
  ...
  "corrosion_resistant",
    ...
    "outsole_material",
    "hi_vis_class",
    "cut_protection_class",
    "flame_protection",
    "arc_protection_class",
    ...
    "max_load_kg",
    "norm",
    "fire_extinguisher_agent",
    "fire_extinguisher_weight_kg",
    "fire_extinguisher_rating",
    "fire_blanket_size",
    "first_aid_standard",
    "first_aid_type",
    "sign_standard",
